...
from src2.utilities.attacks import _evaluate_cstr, torch_whitebox_attack
from src2.utilities.config import (
    AbstractDomain,
    DomainSplittingConfig,
    MNBabVerifierConfig,
)
from src2.utilities.general import (
    batch_splits,
        ...
        if self.outer.adversarial_attack:
            ...
            if adversarial_example is not None:
                selected_adv_example = (
                    ...
                    .unsqueeze(0) # Why this unsquezze??
                    .to(input_lb.device)
                )
                selected_adv_example = selected_adv_example.view(input.shape)
