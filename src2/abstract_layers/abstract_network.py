...
sys.path.append(PROJECT_ROOT+"/mn_bab")
sys.path.append(PROJECT_ROOT+"/mn_bab/src2")
sys.path.append(PROJECT_ROOT+"/mn_bab/ELINA")
sys.path.append(PROJECT_ROOT+"/mn_bab/ELINA/python_interface")
sys.path.append(PROJECT_ROOT+"/mn_bab/onnx2pytorch")
sys.path.append(PROJECT_ROOT+"/mn_bab/onnx2pytorch/onnx2pytorch")
print("PYTHONPATH:", os.environ.get("PYTHONPATH", "Not Set"))
print("sys.path:", sys.path)
from src2.abstract_domains.ai_util import AbstractElement
from src2.abstract_layers.abstract_container_module import (
    ActivationLayer,
    ActivationLayers,
)
...
from src2.state.tags import LayerTag, QueryTag
from src2.utilities.abstract_module_mapper import AbstractModuleMapper
from src2.utilities.config import BacksubstitutionConfig
