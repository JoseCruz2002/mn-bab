...
from src2.utilities.config import PrimaHyperparameters
from src2.utilities.prima_util import ActivationType, KAct, encode_kactivation_cons
...
def _build_sparse_prima_coefficient_matrix(
    ...
    #print("-- prima_interface; _build_sparse_prima_coefficient_matrix;")
    #print("output_coefs:",  torch.isnan(output_coefs).any().item())
    #print("input_coefs:",  torch.isnan(input_coefs).any().item())
    #print("----------------------------------------------------------------")
