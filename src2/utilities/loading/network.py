...
from src2.concrete_layers.basic_block import BasicBlock
from src2.concrete_layers.pad import Pad
from src2.utilities.onnx_loader import ConvertModel
...
def load_net(  # noqa: C901
    ...
    if hasattr(original_network, "blocks"):
...
def load_onnx(path: str):
    ...
    if "vnncomp24" in path or "elsa_comp" in path:
        path = os.path.join(os.path.dirname(__file__), f"../../../{path}")
