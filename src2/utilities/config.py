...
class Config:
    ...
    # Added by José Cruz
    # This configuration tells MN-BaB that the model to verify uses BINARY features.
    check_binary_features: bool
    ...
    def __init__(self, config: Bunch):
        ...
        # Added by José Cruz
        self.check_binary_features = config.get("check_binary_features", False)
