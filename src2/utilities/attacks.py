...
def _evaluate_cstr(
    ...
    # This change is introduced by José Cruz. The adversarial examples calculated have a shape of
    # (1, 1, num_classes). In the mean time, the expected shape of the output is (1, num_classes).
    # Here I reshape the output to be congruent with the expected shape. The change was not done here.
    # It is in line 892 in mn_bab_verifier.py (remove an unsquezze)
    ...
    for or_list in constraints:
        ...
        for cstr in or_list:
            if cstr[0] == -1:
                ...
                #print(f"-- attacks; _evaluate_cstr; net_out: {net_out.shape}, {net_out}")
