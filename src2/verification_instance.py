...
from src2.utilities.loading.vnn_spec_loader import (  # translate_constraints_to_label,
    parse_vnn_lib_prop,
)
from src2.utilities.prepare_instance import get_network_characteristics
...
class VerificationInstance:
    ...
    def run_instance(self) -> None:  # noqa: C901
        ...
        print(f"-- verification_instance; run_instance; type(self.network): {type(self.network)}")
